...
export const BASE_DIALOGUES: DialogueLine[][] = [
  ...
  [
    ...
    { speaker: 'Gavin Newsom', text: '你今天怎么答应的这么快？' },
    { speaker: 'Elon Musk', text: '因为我今天想讨论火星。' },
    { speaker: 'Gavin Newsom', text: '……这有什么区别啊？' }
  ],
  [
  ...
  [
    { speaker: 'Gavin Newsom', text: '你知道我们只是来喝咖啡的，对吧？' },
  ...
  [
    { speaker: 'Gavin Newsom', text: '你怎么知道我喜欢涅槃乐队？' },
    { speaker: 'Elon Musk', text: '因为你说过。' },
    { speaker: 'Gavin Newsom', text: '我以为你没听见呢。' },
    { speaker: 'Elon Musk', text: '我只是单纯不想理你。' }
  ],
  [
    { speaker: 'Gavin Newsom', text: '今天不要惹麻烦。' },
    { speaker: 'Elon Musk', text: '我从来不主动惹麻烦。' },
    { speaker: 'Gavin Newsom', text: '……你确定吗？' },
    { speaker: 'Elon Musk', text: '确定，通常都是麻烦自己来的。' }
  ],
  [
    { speaker: 'Gavin Newsom', text: '你又在看什么？' },
    { speaker: 'Elon Musk', text: '天气。' },
    { speaker: 'Gavin Newsom', text: '天气有什么好看的？' },
    { speaker: 'Elon Musk', text: '你刚刚说今天会下雨。' },
    { speaker: 'Gavin Newsom', text: '所以呢？' },
  ...
  [
    ...
    { speaker: 'Gavin Newsom', text: '没有为什么。' }
  ],
  [
    ...
    { speaker: 'Elon Musk', text: '呵呵。' }
  ],
  [
    { speaker: 'Gavin Newsom', text: '今天到这里。' },
    { speaker: 'Elon Musk', text: '行吧。' },
    { speaker: 'Gavin Newsom', text: '你怎么还没走？' },
    { speaker: 'Elon Musk', text: '谁先走谁傻逼。' }
  ],
  [
  ...
  [
    ...
    { speaker: 'Elon Musk', text: '我知道。' },
    { speaker: 'Gavin Newsom', text: '那你为什么扯到火星了？' },
    { speaker: 'Elon Musk', text: '因为我准备把火星第一个基地取名加州。' },
    { speaker: 'Gavin Newsom', text: '……你故意的吧。' }
  ],
  [
  ...
  [
    ...
    { speaker: 'Gavin Newsom', text: '迷路了？' },
    { speaker: 'Elon Musk', text: '探索。' }
  ],
  [
  ...
  [
    ...
    { speaker: 'Elon Musk', text: '宇宙已经等了 138 亿年，宇宙都不着急，他们可以多等一天。' }
  ],
  [
    { speaker: 'Gavin Newsom', text: '火星上可以留一个咖啡馆吗？' },
  ...
  [
    ...
    { speaker: 'Gavin Newsom', text: '那是海獭的保护区。' },
